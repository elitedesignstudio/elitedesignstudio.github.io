( function( api ) {
    ...
    api.bind( 'ready', function() {
            ...
            if( typeof jQuery(el).data('depend-by') !== "undefined" ){
                ...
                if( 
                    ...
                    observable_control.on('input', function(){
                        ogo_reactive_dependency( jQuery(this), depend_operator, depend_value, jQuery(el), depend_default );
                    });
                } else {
        ...
        function ogo_reactive_dependency( observable, depend_operator, depend_value, changeable, depend_default ){
