		...
		class rb_ext_VC_Config{
			...
			public function extend_shortcodes (){
				...
				if( class_exists('WooCommerce') ){
					$shortcodes[] = 'rb_sc_filter_products';
				}

				if( OGO__ACTIVE ){
					foreach( $shortcodes as $shortcode ){
						require_once( trailingslashit( get_template_directory() ) . 'vc/theme_shortcodes/'.$shortcode.'.php' );
						require_once( OGO__PLUGINS_DIR . 'rb-essentials/render_vc_shortcodes/'.$shortcode.'.php' );
					}
				}
			}
		...
		class VC_RB_Background extends rb_ext_VC_Config{
			...
			public static function rb_open_vc_shortcode($atts, $content){
				...
				if( $add_shadow ){
					$styles .= "
						#".$id." > .vc_row{
							-webkit-box-shadow: 0 0 15px 0px ".esc_attr($shadow_color).";
							-moz-box-shadow: 0 0 15px 0px ".esc_attr($shadow_color).";
							box-shadow: 0 0 15px 0px ".esc_attr($shadow_color).";
						}
					";
				}
				if( $nowrap ){
			...
			public static function rb_open_vc_shortcode_column($atts, $content){
				...
				if( !empty($min_width) ){
					$styles .= "
						@media screen and (max-width: 1600px) and (min-width: 1200px){
							#".$id."{
								min-width: ".(int)esc_attr($min_width)."px;
							}
						}
					";	
				}
			...
			function rb_extra_vc_params(){
				...
				$group_name = esc_html__('Design Options', 'ogo');
				$landscape_group = esc_html__('Tablet', 'ogo')."&nbsp;&nbsp;&nbsp;<i class='vc-composer-icon vc-c-icon-layout_landscape-tablets'></i>";
				$portrait_group = esc_html__('Tablet', 'ogo')."&nbsp;&nbsp;&nbsp;<i class='vc-composer-icon vc-c-icon-layout_portrait-tablets'></i>";
				$mobile_group = esc_html__('Mobile', 'ogo')."&nbsp;&nbsp;&nbsp;<i class='vc-composer-icon vc-c-icon-layout_portrait-smartphones'></i>";
				...
				if( function_exists('vc_add_param') ){
					...
					vc_add_param(
						...
						array(
							"type" 			=> "dropdown",
							"heading" 		=> esc_html__("Overlay", 'ogo'),
							"param_name"	=> "bg_rb_color",
							"group" 		=> $group_name,
							"value" 		=> array(
								esc_html__("None", 'ogo') => "none",
								esc_html__("Color", 'ogo') => "color",
								esc_html__("Gradient", 'ogo') => "gradient",
							),
						)
					);
					vc_add_param(
					...
					vc_add_param(
						...
						array(
							"type"				=> "textfield",
							"heading"			=> esc_html__( 'Opacity', 'ogo' ),
							"param_name"		=> "rb_gradient_opacity",
							"group" 			=> $group_name,
							"edit_field_class" 	=> "vc_col-xs-4",
							"description"		=> esc_html__( '100 - visible, 0 - invisible', 'ogo' ),
							"dependency"		=> array(
								"element"	=> "bg_rb_color",
								'value' 	=> 'gradient',						
							),
					...
					vc_add_param(
						...
						array(
							...
							"value" 			=> array(
								esc_html__("Linear", 'ogo') => "linear",
								esc_html__("Radial", 'ogo') => "radial",
							),
						)
					);
					vc_add_param(
						...
						array(
							"type"				=> "textfield",
							"heading"			=> esc_html__( 'Angle', 'ogo' ),
							"param_name"		=> "rb_gradient_angle",
							"value" 			=> '45',
							"group" 			=> $group_name,
							"edit_field_class" 	=> "vc_col-xs-6",
							"description"		=> esc_html__( 'Degrees: -360 to 360', 'ogo' ),
							"dependency"		=> array(
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Shape variant", 'ogo'),
							...
							"value" 			=> array(
								esc_html__("Simple", 'ogo') => "simple",
								esc_html__("Extended", 'ogo') => "extended",
							),
						)
					);
					vc_add_param(
						...
						array(
							...
							"value" 			=> array(
								esc_html__("Ellipse", 'ogo') => "ellipse",
								esc_html__("Circle", 'ogo') => "circle",
							),
						)
					);
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading"			=> esc_html__("Size keyword", 'ogo'),
							...
							"value" => array(
								esc_html__("Closest side", 'ogo') => "closest-side",
								esc_html__("Farthest side", 'ogo') => "farthest-side",
								esc_html__("Closest corner", 'ogo') => "closest-corner",
								esc_html__("Farthest corner", 'ogo') => "farthest-corner",
							),
						)
					);
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Size", 'ogo'),
							"param_name"		=> "rb_gradient_size_type",
							"group" 			=> $group_name,
							"edit_field_class" 	=> "vc_col-xs-6",
							"description"		=> esc_html__( 'Two space separated percent values, for example (60% 55%)', 'ogo' ),
							"dependency"		=> array(
								"element"	=> "rb_gradient_shape_variant_type",
								'value' 	=> 'extended',	
							),
					...
					vc_add_param(
						...
						array(
							...
							"group" 			=> $group_name,						
							"value"				=> array( esc_html__( 'Add Layer', 'ogo' ) => true )
						)
					);					
					vc_add_param(
						'vc_row',
					...
					vc_add_param(
						...
						array(
							'type' 				=> 'dropdown',
							'heading' 			=> esc_html__( 'Layer position', 'ogo' ),
					...
					vc_add_param(
						...
						array(
							'type' 				=> 'textfield',
							'heading' 			=> __( 'Layer width', 'ogo' ),
							'param_name' 		=> 'extra_layer_width',
							"group" 			=> $group_name,
							'description' 		=> __( 'In percents', 'ogo' ),
							"edit_field_class" 	=> "vc_col-xs-6",
							'dependency' 		=> array(
								'element' 	=> 'add_layers',
								'not_empty' => true,
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Layer Image Size", 'ogo'),
							...
							"value" => array(
								esc_html__("Initial", 'ogo') => "initial",
								esc_html__("Cover", 'ogo') => "cover",
								esc_html__("Contain", 'ogo') => "contain",
							),
						)
					);
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Layer Image Position", 'ogo'),
							...
							"value" 			=> array(
								esc_html__("Left Top", 'ogo') => "left top",
								esc_html__("Left Center", 'ogo') => "left center",
								esc_html__("Left Bottom", 'ogo') => "left bottom",
								esc_html__("Right Top", 'ogo') => "right top",
								esc_html__("Right Center", 'ogo') => "right center",
								esc_html__("Right Bottom", 'ogo') => "right bottom",
								esc_html__("Center Top", 'ogo') => "center top",
								esc_html__("Center Center", 'ogo') => "center center",
								esc_html__("Center Bottom", 'ogo') => "center bottom",
							),	
						)
					);
					vc_add_param(
						...
						array(
							...
							"value" 			=> array(
								esc_html__("No Repeat", 'ogo') => "no-repeat",
								esc_html__("Repeat", 'ogo') => "repeat",
								esc_html__("Repeat X", 'ogo') => "repeat-x",
								esc_html__("Repeat Y", 'ogo') => "repeat-y",
							),	
						)
					);			
					vc_add_param(
						...
						array(
							"type" 				=> "colorpicker",
							"heading" 			=> esc_html__("Layer Background Color", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Layer Margin", 'ogo'),
							"param_name" 		=> "extra_layer_margin",
							"group" 			=> $group_name,
							"edit_field_class" 	=> "vc_col-xs-6",
							"description"		=> esc_html__( '1, 2( top/bottom, left/right ) or 4, space separated, values with units', 'ogo' ),
							"dependency"		=> array(
								"element"	=> "add_layers",
								"not_empty"	=> true
							),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Layer Opacity", 'ogo'),
							"param_name" 		=> "extra_layer_opacity",
							"group" 			=> $group_name,
							"edit_field_class" 	=> "vc_col-xs-6",
							"description"		=> esc_html__( '100 = Visible, 0 = Transparent', 'ogo' ),
							"dependency"		=> array(
								"element"	=> "add_layers",
								"not_empty"	=> true
							),
					...
					vc_add_param(
						...
						array(
							...
							"value"			=> array( esc_html__( 'Hide Layer', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_row',
					...
					vc_add_param(
						...
						array(
							...
							"param_name" 		=> "nowrap",
							"group" 			=> $group_name,
							"value" 			=> array( esc_html__( 'No wrap childrens', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_row',
						array(
							...
							"group" 			=> $group_name,
							"value" 			=> array( esc_html__( 'Add Shadow', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_row',
						array(
							"type" 				=> "colorpicker",
							"heading" 			=> esc_html__("Shadow Color", 'ogo'),
					...
					vc_add_param(
						...
						array(
							...
							"group" 		=> $group_name,
							"value"			=> array( esc_html__( 'Add particles', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_row',
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Area Width (with unit)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Area Height (with unit)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Hide Particles on Choosen Resolution", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Particles Left Offset (with unit)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Particles Top Offset (with unit)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Particles Start Pos", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Particles Speed (0 to 10)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Particles Size (1 to 50)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Particles Count (1 to 500)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Particles Shape", 'ogo'),
							...
							"value" 			=> array(
								esc_html__("Circle", 'ogo') 	=> "circle",
								esc_html__("Square", 'ogo') 	=> "edge",
								esc_html__("Hexagon", 'ogo') 	=> "polygon",
								esc_html__("Image", 'ogo') 	=> "image",
							),
						)
					);
					vc_add_param(
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Particles Mode", 'ogo'),
							...
							"group" 			=> $group_name,
							"value" 			=> array(
								esc_html__("Out", 'ogo') 		=> "out",
								esc_html__("Bounce", 'ogo') 	=> "bounce",
							),
						)
					);
					vc_add_param(
						...
						array(
							...
							"group" 			=> $group_name,
							"value" 			=> array( esc_html__( 'Particles Linked', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_row',
						array(
							"type" 				=> "colorpicker",
							"heading" 			=> esc_html__("Particles Color (#HEX Only!)", 'ogo'),
					...
					vc_add_param(
						...
						array(
							...
							"param_name"		=> "add_mask",
							"group" 			=> $group_name,
							"description"		=> esc_html__( 'Mask usage is not recommended when particles or layers enabled.', 'ogo' ),
							"value"				=> array( esc_html__( 'Add SVG Mask', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_row',
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Row Z-Index", 'ogo'),
							"param_name" 		=> "z_index",
							"edit_field_class" 	=> "vc_col-xs-6",
							"group" 			=> $group_name,
							"value" 			=> "",
					...
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Row Bottom Shift", 'ogo'),
							"param_name" 		=> "shift",
							"edit_field_class" 	=> "vc_col-xs-6",
							"group" 			=> $group_name,
							"value" 			=> "",
					...
					vc_add_param(
						...
						array(
							...
							"edit_field_class" 	=> "vc_col-xs-6",
							"group" 			=> $group_name,
							"value"				=> array( esc_html__( 'Could be shrinked', 'ogo' ) => true )
						)
					);
					vc_add_param(
						'vc_column',
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Min Width", 'ogo'),
							"param_name"		=> "min_width",
							"edit_field_class" 	=> "vc_col-xs-6",
							"group" 			=> $group_name,
							"description"		=> esc_html__( 'Only for desktops & laptops', 'ogo' ),
						)
					);
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Animate on load", 'ogo'),
							"param_name"		=> "animation_load",
							"group" 			=> $group_name,
							"value" 			=> array(
								esc_html__("None", 'ogo') 				=> "none",
								esc_html__("Fade From Left", 'ogo') 		=> "fade_left",
								esc_html__("Fade From Right", 'ogo') 		=> "fade_right",
								esc_html__("Fade From Bottom", 'ogo') 	=> "fade_bottom",
								esc_html__("Slide From Left", 'ogo') 		=> "grow_left",
								esc_html__("Slide From Right", 'ogo') 	=> "grow_right",
								esc_html__("Slide From Bottom", 'ogo') 	=> "grow_bottom",
							),
						)
					);
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Duration", 'ogo'),
							"param_name"		=> "animation_duration",
							"edit_field_class" 	=> "vc_col-xs-4",
							"group" 			=> $group_name,
							"description"	=> esc_html__( 'In milliseconds', 'ogo' ),
							"dependency"	=> array(
					...
					vc_add_param(
						...
						array(
							"type" 				=> "dropdown",
							"heading" 			=> esc_html__("Timing Function", 'ogo'),
							...
							"value" 			=> array(
								esc_html__("Ease", 'ogo') 						=> "ease",
								esc_html__("Preconfigured Cubic-Bezier", 'ogo') 	=> "cubic-bezier(.35,.71,.26,.88)",
								esc_html__("Ease in Out", 'ogo') 					=> "ease-in-out",
								esc_html__("Linear", 'ogo') 						=> "linear",
								esc_html__("Custom", 'ogo') 						=> "custom",
							),
						)
					);
					vc_add_param(
						...
						array(
							"type" 				=> "textfield",
							"heading" 			=> esc_html__("Custom Timing Function", 'ogo'),
							"param_name"		=> "custom_timing_function",
							"group" 			=> $group_name,
							"description"	=> esc_html__( 'Enter transition timing function', 'ogo' ),
							"dependency"	=> array(
					...
					vc_add_param(
						...
						array(
							...
							"group" 		=> $mobile_group,
							"description"	=> esc_html__( 'If this column have`t content, use "padding-top" or "padding-bottom" properties for set the column height', 'ogo' ),
							"value"			=> array( esc_html__( 'Put this column on first place', 'ogo' ) => true )
						)
					);
					...
					vc_add_param(
						...
						array(
							"type" 			=> "checkbox",
							"param_name" 	=> "add_shadow",
							"group" 		=> esc_html__('Design Options', 'ogo'),
							"value"			=> array( esc_html__( 'Add Shadow', 'ogo' ) => true )
						)
					);
