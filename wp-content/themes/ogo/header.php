...
$is_default_sb = (is_home() || is_front_page() || (class_exists('WooCommerce') && is_shop())) || !OGO__ACTIVE;

$custom_sidebar = rb_get_metabox('page_sidebar');
$custom_sidebar_pos = rb_get_metabox('sidebar_pos');

$sidebar = $is_default_sb ? ogo__get_sidebar( get_queried_object_id() ) : ogo__get_sidebar( get_queried_object_id(), $custom_sidebar, $custom_sidebar_pos );
$tb_sidebar = get_theme_mod('icon_custom_sb') ? ogo__get_sidebar( get_queried_object_id(), get_theme_mod('custom_sidebar'), 'right', get_theme_mod('custom_sidebar'), true ) : '';
...
<html <?php language_attributes() ?> class="no-js">
	...
	<body <?php body_class() ?> data-boxed="<?php echo get_theme_mod('boxed_layout') ? 'true' : 'false'; ?>" data-default="<?php echo !OGO__ACTIVE ? 'true' : 'false'; ?>" itemscope="itemscope" itemtype="http://schema.org/WebPage">
