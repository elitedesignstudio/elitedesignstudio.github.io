			...
			<div class="portfolio-content-wrapper">
				...
				<div class="aside-part">
					<?php if( !empty($categories) ) : ?>
						<div>
							<span class="label">
								<?php echo strripos($categories, ',') !== false ? esc_html_x('Categories:', 'frontend', 'ogo') : esc_html_x('Category:', 'frontend', 'ogo') ?>
							</span>
					...
					<?php if( !empty($tags) ) : ?>
						<div>
							<span class="label">
								<?php echo strripos($tags, ',') !== false ? esc_html_x('Tags:', 'frontend', 'ogo') : esc_html_x('Tag:', 'frontend', 'ogo') ?>
							</span>
					...
					<?php if( !empty($author) ) : ?>
						<div>
							<span class="label">
								<?php echo esc_html_x('Author:', 'frontend', 'ogo'); ?>
							</span>
					...
					<?php if( !empty($client) ) : ?>
						<div>
							<span class="label">
								<?php echo esc_html_x('Client:', 'frontend', 'ogo'); ?>
							</span>
					...
					<div>
						<span class="label">
							<?php echo esc_html_x('Date:', 'frontend', 'ogo'); ?>
						</span>
						<?php echo get_the_date(); ?>
					</div>
					<div class="social-share">
						<span class="label"><?php echo esc_html_x('Share:', 'frontend', 'ogo'); ?></span>
