	...
	<?php while ( have_posts() ): the_post(); ?>
		...
		<div class="main_member_info" <?php echo sprintf('%s', $accent_background); ?>>
			...
			<div class="text-information">
				...
				<?php if( !empty($position) ) : ?>
					<div class="pos">
						<span class="label">
							<?php echo strripos($position, ',') !== false ? esc_html_x('Positions:', 'frontend', 'ogo') : esc_html_x('Position:', 'frontend', 'ogo') ?>
						</span>
				...
				<?php if( !empty($department) ) : ?>
					<div class="dep">
						<span class="label">
							<?php echo strripos($department, ',') !== false ? esc_html_x('Departments:', 'frontend', 'ogo') : esc_html_x('Department:', 'frontend', 'ogo') ?>
						</span>
				...
				<?php if( !empty($experience) ) : ?>
					<div class="experience">
						<span class="label">
							<?php echo esc_html_x('Experience:', 'frontend', 'ogo') ?>
						</span>
				...
				<?php if( !empty($email) ) : ?>
					<div class="email">
						<span class="label">
							<?php echo esc_html_x('Email:', 'frontend', 'ogo') ?>
						</span>
				...
				<?php if( !empty($phone) ) : ?>
					<div class="phone">
						<span class="label">
							<?php echo esc_html_x('Tel:', 'frontend', 'ogo') ?>
						</span>
		...
		<?php if( !empty($biography) ) : ?>
			<div class="secondary_member_info">
				<h4><?php echo esc_html_x('Biography:', 'frontend', 'ogo') ?></h4>
		...
		<?php if( !empty($content) ) : ?>
			<div class="secondary_member_info">
				<h4><?php echo esc_html_x('Personal Information:', 'frontend', 'ogo') ?></h4>
