...
<nav class="navigation post-navigation" role="navigation">
	<ul class="nav-links">
		<?php if ( is_attachment() ): ?>
			<?php previous_post_link( '<li>%link</li>', sprintf( '<span class="meta-nav">%s</span> %%title', esc_html__( 'Published In', 'ogo' ) ) ); ?>
		<?php else: ?>
				...
				<li class="prev-post">
					...
					<div class="post-nav-text-wrapper">
						<div class="post-nav-link">
							<a href="<?php echo get_permalink( $prev_post ) ?>">
								<?php echo esc_html_x('Prev Post', 'single page', 'ogo'); ?>
							</a>
						</div>
						<a href="<?php echo get_permalink( $prev_post ) ?>">
					...
					<div class="post-nav-text-wrapper">
						<div class="post-nav-link">
							<a href="<?php echo get_permalink( $next_post ) ?>">
								<?php echo esc_html_x('Next Post', 'single page', 'ogo'); ?>
							</a>
						</div>
						<a href="<?php echo get_permalink( $next_post ) ?>">
