...
function rb_landscape_group_name(){
	return esc_html_x('Tablet', 'VC Group Name', 'ogo')."&nbsp;&nbsp;&nbsp;<i class='vc-composer-icon vc-c-icon-layout_landscape-tablets'></i>";
}
function rb_tablet_group_name(){
	return esc_html_x('Tablet', 'VC Group Name', 'ogo')."&nbsp;&nbsp;&nbsp;<i class='vc-composer-icon vc-c-icon-layout_portrait-tablets'></i>";
}
function rb_mobile_group_name(){
	return esc_html_x('Mobile', 'VC Group Name', 'ogo')."&nbsp;&nbsp;&nbsp;<i class='vc-composer-icon vc-c-icon-layout_portrait-smartphones'></i>";
}
...
function rb_structure_background_props($layout){
	...
	vc_add_param(
		...
		array(
			"type"				=> "dropdown",
			"heading"			=> esc_html__( 'Background Position', 'ogo' ),
			"param_name"		=> "bg_position",
			"group"				=> $group_name,
			"edit_field_class" 	=> "vc_col-xs-6",
			"value"				=> array(
				esc_html__( 'Center Top', 'ogo' ) 		=> 'top',
				esc_html__( 'Center Center', 'ogo' ) 	=> 'center',
				esc_html__( 'Center Bottom', 'ogo' ) 	=> 'bottom',
	...
	vc_add_param(
		...
		array(
			"type"				=> "dropdown",
			"heading"			=> esc_html__( 'Background Size', 'ogo' ),
			"param_name"		=> "bg_size",
			"group"				=> $group_name,
			"edit_field_class" 	=> "vc_col-xs-6",
			"value"				=> array(
				esc_html__( 'Auto', 'ogo' ) 		=> 'auto',
	...
	vc_add_param(
		...
		array(
			"type"				=> "dropdown",
			"heading"			=> esc_html__( 'Background Repeat', 'ogo' ),
	...
	vc_add_param(
		...
		array(
			"type" 				=> "dropdown",
			"heading" 			=> esc_html__("Background Attachment", 'ogo'),
			"param_name" 		=> "bg_attachment",
			"group"				=> $group_name,
			"edit_field_class" 	=> "vc_col-xs-6",
			"value" 			=> array(
				esc_html__("Scroll", 'ogo') => "scroll",
				esc_html__("Fixed", 'ogo') => "fixed",
			)
		)
	);
	vc_add_param(
	...
	vc_add_param(
		...
		array(
			"type"				=> "dropdown",
			"heading"			=> esc_html_x( 'Background Hover Effect', 'RB_VC_Banner', 'ogo' ),
			"param_name"		=> "bg_hover",
			"group"				=> $group_name,
			"edit_field_class" 	=> "vc_col-xs-6",
			"value"				=> array(
				esc_html_x( 'No Hover', 'RB_VC_Banner', 'ogo' )		=> 'no_hover',
				esc_html_x( 'Zoom In', 'RB_VC_Banner', 'ogo' )		=> 'zoom_in',
				esc_html_x( 'Zoom Out', 'RB_VC_Banner', 'ogo' )		=> 'zoom_out',
				esc_html_x( 'Shift right', 'RB_VC_Banner', 'ogo' )	=> 'shift_right',
				esc_html_x( 'Shift left', 'RB_VC_Banner', 'ogo' )	=> 'shift_left',
			),
			"description"		=> esc_html_x( "Background Size & Background Position will be ignored with any property except 'No Hover'", "RB_VC_Banner", 'ogo'),
			"std"				=> 'no_hover'
		)
	);
	vc_add_param(
		...
		array(
			"type"				=> "textfield",
			"heading"			=> esc_html_x( 'Animation Durations (sec.)', "RB_VC_Banner", 'ogo' ),
	...
	vc_add_param(
		...
		array(
			...
			"group"			=> $landscape_group,
			"value"			=> array( esc_html__( 'Customize Background', 'ogo' ) => true )
		)
	);
	vc_add_param(
		$layout,
	...
	vc_add_param(
		...
		array(
			...
			"group"			=> $landscape_group,
			"value"			=> array( esc_html__( 'Hide Background', 'ogo' ) => true )
		)
	);
...
function rb_module_background_props(){
	$background_properties = array(
		...
		array(
			...
			"group"			=> esc_html__( "Styling", 'ogo' ),
			"responsive"	=> "all",
			"value"			=> array( esc_html__( 'Hide Background on this resolution', 'ogo' ) => true )
		),
	);
...
function rb_ext_icon_vc_sc_config_params( $dep_el = "", $dep_val = false, $value_el = false ){
	$libs_param = array(
		'type' => 'dropdown',
		'heading' => __( 'Icon library', 'ogo' ),
		'value' => array(
			__( 'Font Awesome', 'ogo' ) => 'fontawesome',
			__( 'Open Iconic', 'ogo' ) => 'openiconic',
			__( 'Typicons', 'ogo' ) => 'typicons',
			__( 'Entypo', 'ogo' ) => 'entypo',
			__( 'Linecons', 'ogo' ) => 'linecons',
			__( 'Mono Social', 'ogo' ) => 'monosocial',
		),
		'param_name' => 'icon_lib',
		'description' => __( 'Select icon library.', 'ogo' ),
	);
	if ( !empty( $dep_el ) ){
	...
	$flat_icons_first = '';
	$flat_icons_lib_key = esc_html_x( 'RB Flaticons', 'backend', 'ogo' );
	...
	$svg_lib_key = esc_html_x( 'RB SVG', 'backend', 'ogo' );
