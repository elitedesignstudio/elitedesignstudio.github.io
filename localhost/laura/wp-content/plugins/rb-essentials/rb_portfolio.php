...
function register_rb_portfolio (){
	...
	$labels = array(
		'name' => esc_html_x( 'Portfolio', 'backend', 'ogo' ),
		'singular_name' => esc_html_x( 'Portfolio Item', 'backend', 'ogo' ),
		'menu_name' => esc_html_x( 'Portfolio', 'backend', 'ogo' ),
		'add_new' => esc_html_x( 'Add New', 'backend', 'ogo' ),
		'add_new_item' => esc_html_x( 'Add New Portfolio Item', 'backend', 'ogo' ),
		'edit_item' => esc_html_x('Edit Portfolio Item', 'backend', 'ogo' ),
		'new_item' => esc_html_x( 'New Portfolio Item', 'backend', 'ogo' ),
		'view_item' => esc_html_x( 'View Portfolio Item', 'backend', 'ogo' ),
		'search_items' => esc_html_x( 'Search Portfolio Item', 'backend', 'ogo' ),
		'not_found' => esc_html_x( 'No Portfolio Items found', 'backend', 'ogo' ),
		'not_found_in_trash' => esc_html_x( 'No Portfolio Items found in Trash', 'backend', 'ogo' ),
		'parent_item_colon' => '',
	);

	register_post_type( 'rb_portfolio', array(
		'label' => esc_html_x( 'Portfolio items', 'backend', 'ogo' ),
		'labels' => $labels,
		'public' => true,
...
function add_rb_portfolio_thumb_name ($columns) {
	$columns = array_slice($columns, 0, 1, true) +
				array('rb_portfolio_thumbnail' => esc_html_x('Thumbnails', 'backend', 'ogo')) +
